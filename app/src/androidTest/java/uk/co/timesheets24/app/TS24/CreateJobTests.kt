...
import uk.co.timesheets24.app.TS24.Views.CreateJob.CreateJobViewModel
...
class CreateJobTests {
    ...
    fun createJob() = runBlocking {
        ...
        val startSize = dao.fetchJobs().size

        viewModel.selectedDate.value = "2025-07-15"
        viewModel.description.value = "test job"
        ...
        assert(dao.fetchJobs().size > startSize)
