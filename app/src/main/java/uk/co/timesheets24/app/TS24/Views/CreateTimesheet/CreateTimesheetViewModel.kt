...
//    val jobPosting = mutableStateOf<LiveJob?>(currentJob)
    ...
    fun sendTimeSheet(context: Context) {
        ...
        viewModelScope.launch {
            try {
                ...
                jobApi.postTimesheet("Bearer ${GlobalLookUp.token}", TimeSheetEntry(jobGUID = "", timeSheetId = "", contactId = GlobalLookUp.contactId,
